...
} from '@/features/cloud/utils/availability';
    ...
    <View className="flex-1 bg-background-0">
      ...
      <ScrollView className="flex-1">
        <VStack className="px-5 pb-8 pt-4" space="md">
          {!keychainAvailable && (
            <HStack space="sm" className="items-start rounded-xl bg-background-50 p-3">
          ...
          <CredentialField
            ...
            onTest={async (key) => {
              ...
              return (
                [email, balance != null ? `$${balance.toFixed(2)} credit` : null]
                  .filter(Boolean)
                  .join(' · ') || 'Key is valid'
              );
            }}
              ...
              <HStack className="items-center justify-between">
                <HStack space="sm" className="items-center">
                  ...
                  <VStack>
                    ...
                    <Text className="text-xs text-typography-400">
                      What to install on a fresh instance
                    </Text>
                  </VStack>
                </HStack>
